...
- ✅ **GenAI Quality Features** — TTFT SLOs, LLM-as-Judge (cached), hallucination detection, cost budgets, agent reliability tracking
...
| **[GenAI Quality Features](docs/guides/user-guide.md#genai-mode)** | TTFT SLOs, LLM-as-Judge, hallucination detection, cost budgets, agent SLOs |
